    ...
    methods: {
        ...
        tableLoad(params,jumpFirst){
            ...
            this.$emit('pageHeaderFormData',function(formData){
                ...
                self.loading = true;
                httpGet('aooms/rbac/userService/findList', params).then(res => {
                    self.loading = false;
        ...
        handleDelete: function (type , selection) {
            ...
            this.$confirm('确定删除选择的数据?', '提示', {
                ...
                httpPost('aooms/rbac/userService/delete',submitData).then(res => {
                    this.$message({
                        type: 'success',
        ...
        handleStatusChange(val,row){
            ...
            httpPost('aooms/rbac/userService/updateStatus',submitData).then(res => {
